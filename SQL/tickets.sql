...
-- Tiempo de generación: 25-10-2021 a las 02:05:00
...
CREATE TABLE `tickets` (
  ...
  `nombre_ticket` varchar(50) NOT NULL,
  `comentarios_ticket` text NOT NULL,
  `estado_ticket` int(2) NOT NULL,
  `id_historia_ticket` int(5) NOT NULL,
