...
-- Tiempo de generación: 25-10-2021 a las 02:00:58
...
CREATE TABLE `historias` (
  ...
  `nombre_historia` varchar(50) NOT NULL,
  `id_proyecto_historia` int(10) NOT NULL,
  `fecha_historia` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
--
ALTER TABLE `historias`
  MODIFY `id_historia` int(10) NOT NULL AUTO_INCREMENT;
COMMIT;
