...
-- Tiempo de generación: 24-10-2021 a las 02:13:13
...
CREATE TABLE `company` (
  ...
  `nombre_company` text CHARACTER SET utf8 NOT NULL,
  `nit_company` varchar(12) NOT NULL,
  `telefono_company` varchar(30) NOT NULL,
...
ALTER TABLE `company`
  ...
  ADD UNIQUE KEY `nit_company` (`nit_company`);
