...
<?php include("config-ini.php"); ?>
  ...
  <meta name="author" content="RZA">

  <title><?php echo $q_cliente; ?></title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"><?php echo $q_cliente; ?></h1>
                  </div>
...
<div class="small text-center text-white p-5">Desarrollado en Colombia por : <a class="text-white" href="https://zarate.com.co">Rodrigo Zarate Algecira</a></div>
</body>
